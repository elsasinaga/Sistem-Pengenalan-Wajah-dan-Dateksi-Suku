...
# Fungsi deteksi wajah (sama seperti sebelumnya)
detector = MTCNN()
...
processed_df.to_csv('processed_faces_etnis.csv', index=False)
...
model.save('etnis_detection_model.h5')